...
function detectHarnessesInProject(projectRoot = process.cwd()) {
  const detected = [];
  
  for (const [folder, target] of Object.entries(HARNESS_FOLDER_MAP)) {
