  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-[#0B3A9A]">Course Catalog</h1>
          <p className="text-slate-500 text-sm mt-1 font-medium">
            Manage, edit, and track the performance of your educational offerings.
          </p>
        </div>
        <CourseFormModal mode="create" onSuccess={fetchData} />
      </div>
                ...
                >
                  <td className="py-5 px-2">
                    <div className="flex items-center gap-4">
                      <div className={`w-[52px] h-[52px] rounded-xl overflow-hidden shrink-0 ${course.imageColor} relative`}>
                         <Image 
                           src={course.image} 
                           alt={course.name} 
                           fill 
                  ...
                  <td className="py-5 pl-2 pr-4 text-right">
                    <CourseTableRowActions course={course} onSuccess={fetchData} />
                  </td>
                </tr>
              ))}
            </tbody>
